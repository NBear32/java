...
public class Example {
    ...
    public static void createStudentsInfo() {
        ...
        Students[] studentsArray = new Students[names.length];
        for (int i = 0; i < names.length; i++){
            studentsArray[i] = new Students(names[i], departments[i], studentsIds[i]);
//            Students temp = new Students();
//            temp.setName(names[i]);
//            temp.setDepartment(departments[i]);
//            temp.setStudentId(studentsIds[i]);
